...
struct RemainingWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = RemainingWidgetAttributes(name: "Me")
    static let contentState = RemainingWidgetAttributes.ContentState(value: 3)
