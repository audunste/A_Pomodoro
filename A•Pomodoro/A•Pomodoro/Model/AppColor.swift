...
struct AppColor {
    ...
    static let pomodoroLight = AppColor(
        Color(hue: 0.03, saturation: 0.77, brightness: 0.8),
        Color(hue: 0.03, saturation: 0.77, brightness: 1.0))
    
    static let pomodoroDark = AppColor(
        Color(hue: 0.03, saturation: 0.77, brightness: 0.7),
        Color(hue: 0.03, saturation: 0.77, brightness: 0.9),
        textColor: Color(white: 0.95))

    static let shortBreakLight = AppColor(
        Color(hue: 0.32, saturation: 0.67, brightness: 0.54),
        Color(hue: 0.32, saturation: 0.67, brightness: 0.74))

    static let shortBreakDark = AppColor(
        Color(hue: 0.32, saturation: 0.67, brightness: 0.46),
        Color(hue: 0.32, saturation: 0.67, brightness: 0.66),
        textColor: Color(white: 0.95))
